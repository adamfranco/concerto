 ...
 * @version $Id$
 */
class import_slideshowAction extends MainWindowAction {
	/**
	...
	function getUnauthorizedMessage () {
		...
		$exhibition =& $repository->getAsset($idManager->getId(
			$harmoni->request->get("exhibition_id")));
		
		$harmoni->request->endNamespace();
		
		return _("You are not authorized to import into the <em>").
			$exhibition->getDisplayName()._("</em> Exhibition.");
	}
	...
	function getHeadingText () {
		...
		return _("Import a slideshow into the <em>").
			$exhibition->getDisplayName()._("</em> Exhibition.");
	}
	...
	function buildContent () {
		...
		$cacheName = 'import_slideshow_wizard';
